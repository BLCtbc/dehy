...
from oscar.apps.payment import forms as base_forms
...
class BankcardForm(base_forms.BankcardForm):
	...
	number = BankcardNumberField(types=[bankcards.VISA, bankcards.VISA_ELECTRON,bankcards.MASTERCARD, bankcards.DISCOVER, bankcards.AMEX])
